...
- [ ] Add shared state/session utility.

### 5.2 Auth UX
- [x] Login wired to API.
- [ ] Add refresh-token silent re-auth UX.
- [ ] Add logout confirmation for active operations.
- [ ] Add session-expiry warning banner.

### 5.3 Dashboard + Role Views
- [x] Role-aware section toggles present.
- [ ] Add true route guards by role.
- [ ] Add owner dashboard cards (sales, low-stock, sync, dues).
- [ ] Add manager dashboard cards (team + operations).
- [ ] Add cashier quick actions panel.
- [ ] Add staff inventory actions panel.
- [ ] Add admin console split view (tenants/users/plans/audits).

### 5.4 Inventory UX
- [x] Add-item form and list exists.
- [ ] Add inline form validation messages.
- [ ] Add filter chips (category/location/online/stock).
- [ ] Add pagination controls.
- [ ] Add edit-item modal.
- [ ] Add stock movement UI.
- [ ] Add stock audit UI.

### 5.5 E-commerce UX
- [x] Product list + cart + create order exists.
- [ ] Add order board (pending/accepted/completed/cancelled).
- [ ] Add customer details form for checkout.
- [ ] Add order detail drawer.
- [ ] Add cancellation/refund action UI.
...
- [ ] Add lead form with backend endpoint.

## 6) Mobile Platform Track
- [ ] Initialize mobile runtime project.
- [ ] Add auth flow with token storage.
- [ ] Add dashboard screen with KPI cards.
- [ ] Add inventory list screen.
- [ ] Add add-item form screen.
- [ ] Add order list screen.
- [ ] Add order status update flow.
- [ ] Add offline queue indicator.
- [ ] Add network-retry UX for failed API calls.

## 7) Windows Platform Track (POS-first)
- [ ] Initialize windows POS project shell.
- [ ] Add barcode-first search input flow.
- [ ] Add cart line editor with keyboard shortcuts.
- [ ] Add hold bill / resume bill list.
- [ ] Add split payment flow UI.
- [ ] Add print invoice preview layout.
- [ ] Add scanner and printer integration adapter stubs.
- [ ] Add cashier shift close panel.

## 8) Data / Analytics Track
- [ ] Create event taxonomy document in `docs/architecture`.
- [ ] Add event instrumentation to login flow.
- [ ] Add event instrumentation to add-item flow.
- [ ] Add event instrumentation to order create flow.
- [ ] Add event instrumentation to admin actions.
- [ ] Add dashboard metrics API extension for trends.
- [ ] Add telemetry QA checklist.

## 9) QA / Testing Track
- [ ] Add unit tests for auth utils.
- [ ] Add integration tests for login/refresh/logout.
- [ ] Add RBAC deny-path integration tests.
- [ ] Add inventory create/update validation tests.
- [ ] Add order stock deduction + rollback tests.
- [ ] Add admin endpoint permission tests.
- [ ] Add web smoke tests for login + inventory + order.
- [ ] Add test data reset utility.

## 10) DevOps / Local Run Reliability
- [ ] Add backend Dockerfile.
- [ ] Add docker-compose for api + mongo.
...
- [ ] Docs complete, clean, and updated with latest implementation.
- [ ] Local run guide complete so full product is demoable end-to-end.
